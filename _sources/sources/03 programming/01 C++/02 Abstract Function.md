...
int main(void)
{
    ...
    mov eax,dword ptr [pt]  //pt의 값 4바이트를 eax에 넣어라.
                            ...
                            //레지스터가 아닌 변수 이름이 직접 사용될 경우, 변수의 값에서 4바이트를 읽어온다.
                            //레지스터인 경우, 레지스터에 저장된 주소로 가서 그 주소에 저장된 데이터 4바이트를 읽어온다.
                            //pt는 변수명임으로, pt의 값을 4바이트 읽어온다.
                            //이 떄, pt의 값은 t객체의 사적 주소임으로 eax에는 t객체의 주소 4바이트가 들어있다.
