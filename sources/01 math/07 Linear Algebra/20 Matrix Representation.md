...
$$
\begin{aligned}
[\frak{m}_\gamma]^{\epsilon^m}_{\gamma} &= \begin{bmatrix} [\frak{m}_\gamma(\gamma_1)]_{\epsilon^m} & \cdots & [\frak{m}_\gamma(\gamma_m)]_{\epsilon^m} \end{bmatrix} = I_m \\
[\frak{m}_\beta^{-1}]^{\beta}_{\epsilon^n} &= \begin{bmatrix} [\frak{m}_\beta^{-1}(\epsilon^n_1)]_{\beta} & \cdots & [\frak{m}_\beta^{-1}(\epsilon^n_n)]_{\beta} \end{bmatrix} = I_n
\end{aligned}
$$
