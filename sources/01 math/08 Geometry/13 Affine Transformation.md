...
$M$의 값은 $V_A,V_B$에서 선택한 basis $\beta,\gamma$에 의존한다. Basis에 따른 linear map의 matrix representation은 [Change of Basis and Coordinate Matrix](<../07 Linear Algebra/03 Matrix Representation and Eigenstructure/23 Change of Basis and Coordinate Matrix.md>)에서 설명한다.
